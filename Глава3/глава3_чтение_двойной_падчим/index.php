...
<body>
	...
	<section class='main'>
        ...
        <div class="N_glav">Правила чтения</div>

        <div class="name">Двойной патчим</div>
        ...
        <div class="video">
            ...
            <iframe width="1100" height="650" src="https://www.youtube.com/embed/OT-R8MaZXU0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>

        <div class="box_btn">
            <button name="kurs" class="kurs" onclick="location.href='\\курсики\\index.php'"> Список уроков</button>
            <button name="next" class="next" onclick="location.href='..\\php\\sub_8.php'"> Далее</button>
            <button name="back" class="back" onclick="location.href='\\глава3\\глава3_чтение_падчим\\index.php'"> Назад</button>
