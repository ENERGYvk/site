...
<body>
	...
	<section class='main'>
        ...
        <div class="name">Согласные</div>


        <div class="video">

            <iframe width="1100" height="650" src="https://www.youtube.com/embed/0Ps91VIn83k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>

        <div class="box_btn">
            <button name="kurs" class="kurs" onclick="location.href='\\..\\курсики\\index.php'"> Список уроков</button>
            <button name="next" class="next" onclick="location.href='..\\php\\sub_4.php'"> Далее</button>
            <button name="back" class="back" onclick="location.href='\\глава1\\глава1_дифтонги_видео\\index.php'"> Назад</button>
