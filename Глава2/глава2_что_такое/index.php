...
<body>
	...
	<section class='main'>
        ...
        <div class="name">Что такое 입니다</div>
        ...
        <div class="video">
            ...
            <iframe width="1100" height="650" src="https://www.youtube.com/embed/6gL3iDbq-C8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

        </div>

        <div class="box_btn">
            <button name="kurs" class="kurs" onclick="location.href='\\курсики\\index.php'"> Список уроков</button>
            <button name="next" class="next" onclick="location.href='..\\php\\sub_14.php'"> Далее</button>
            <button name="back" class="back" onclick="location.href='\\глава2\\глава2_грамматика_задание\\index.php'"> Назад</button>
