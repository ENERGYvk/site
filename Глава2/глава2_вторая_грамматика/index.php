...
<body>
	...
	<section class='main'>
        ...
        <div class="name">입니까</div>


        <div class="video">


            <iframe width="1100" height="650" src="https://www.youtube.com/embed/NSQU-4NtYJs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>

        <div class="box_btn">
            <button name="kurs" class="kurs" onclick="location.href='\\курсики\\index.php'"> Список уроков</button>
            <button name="next" class="next" onclick="location.href='..\\php\\sub_12.php'"> Далее</button>
            <button name="back" class="back" onclick="location.href='\\глава2\\глава2_первая_грамматика\\index.php'"> Назад</button>
